...
MainWindow::MainWindow(void)
	:	BWindow(BRect(100,100,400,400),"HaikuFortune",B_DOCUMENT_WINDOW,
		...
		fFortune(gFortunePath.String())
{
	...
	// Working around a problem in Zeta. BButton::MakeDefault doesn't do
	// anything except change the focus. We'll leave focus on the Close
	// button.
...
MainWindow::MessageReceived(BMessage *msg)
{
	switch (msg->what)
	{
		...
		{
			// Using BAlert for the About window is a common occurrence.
